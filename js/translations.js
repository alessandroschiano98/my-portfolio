const translations = {
    en: {
      ...
      about_tag_birth: "17th October 1998",
      about_tag_badge: "Visual & UI Creator",
      about_stats_title: "Core Skills & Stats",
      about_stats_sub: "My primary expertise is rooted in <b>Graphic & Visual Design</b>. Web Development, cultural interests, and international adaptability complete my creative profile.",
      tag_primary_focus: "Primary Focus",
      title_design_software: "Design & Media Software",
      continuous_learning_note: "<b>Continuous Evolution:</b> Committed to daily technical growth and actively expanding software workflows.",
      tag_work_ethic: "Work Ethic",
      title_soft_skills: "Professional & Soft Skills",
      tag_communication: "Communication",
      title_languages: "Languages & Mindset",
      tag_lifestyle: "Personal Passions",
      title_lifestyle: "Passions & Inspirations",
      tag_secondary_dev: "Secondary / Extra Skillset",
      title_dev: "Development & Engineering",
      skill_precision: "Precision & Attention to Detail",
      skill_punctuality: "Punctuality & Delivery",
      skill_creativity: "Creativity & Concept Generation",
      skill_problem_solving: "Problem Solving & Adaptability",
      skill_teamwork: "Team Collaboration & Communication",
      skill_stress: "Stress & Pressure Management",
      pref_workflow_label: "Preferred Workflow:",
      pref_workflow_text: "Flourishes in structured, quiet environments with room for deep singular focus and meticulous execution.",
      lang_it_label: "Italian",
      lang_it_sub: "Native",
      lang_en_w_label: "English Written",
      lang_en_w_sub: "B1 / B2 Level",
      lang_en_s_label: "English Spoken",
      lang_en_s_sub: "Conversational",
      ...
      hobby_cinema_desc: "Obsessed with cinematography, visual direction, lighting compositions, and directorial storytelling.",
      hobby_music_title: "Extreme Music Lover",
      hobby_music_desc: "Constant sonic explorer; music sets the rhythm and emotional backdrop for every creative session.",
      hobby_travel_title: "Global Traveler",
      hobby_travel_desc: "Eager explorer of foreign cultures, architecture, and perspectives that constantly renew my creative outlook.",
    ...
    it: {
      ...
      about_tag_birth: "17 Ottobre 1998",
      about_tag_badge: "Visual & UI Creator",
      about_stats_title: "Competenze & Statistiche",
      about_stats_sub: "Il mio nucleo principale è il <b>Graphic & Visual Design</b>. Lo sviluppo web, le passioni culturali e l'adattabilità internazionale completano il mio profilo creativo.",
      tag_primary_focus: "Focus Principale",
      title_design_software: "Software di Design & Media",
      continuous_learning_note: "<b>Evoluzione Continua:</b> Forte propensione all'aggiornamento costante e all'apprendimento rapido di nuovi software e workflow.",
      tag_work_ethic: "Etica del Lavoro",
      title_soft_skills: "Competenze Professionali & Soft Skills",
      tag_communication: "Comunicazione",
      title_languages: "Lingue & Mentalità",
      tag_lifestyle: "Passioni Personali",
      title_lifestyle: "Passioni & Ispirazioni",
      tag_secondary_dev: "Competenza Secondaria / Extra",
      title_dev: "Sviluppo Web & Engineering",
      skill_precision: "Precisione & Cura del Dettaglio",
      skill_punctuality: "Puntualità & Consegne",
      skill_creativity: "Creatività & Ideazione Concept",
      skill_problem_solving: "Problem Solving & Adattabilità",
      skill_teamwork: "Lavoro di Squadra & Comunicazione",
      skill_stress: "Gestione dello Stress & Pressione",
      pref_workflow_label: "Workflow Preferito:",
      pref_workflow_text: "Rendo al massimo in ambienti strutturati e tranquilli, dove posso applicare profonda concentrazione individuale e cura meticolosa.",
      lang_it_label: "Italiano",
      lang_it_sub: "Madrelingua",
      lang_en_w_label: "Inglese Scritto",
      lang_en_w_sub: "Livello B1 / B2",
      lang_en_s_label: "Inglese Parlato",
      lang_en_s_sub: "Conversazionale",
      ...
      hobby_cinema_desc: "Ossessione per la cinematografia d'autore, regia visiva, color grading e la narrazione attraverso le inquadrature.",
      hobby_music_title: "Musicofilo Ossessivo",
      hobby_music_desc: "Ascolto continuo e ricerca sonora; la musica detta il ritmo e l'atmosfera emotiva di ogni mio progetto grafico.",
      hobby_travel_title: "Viaggiatore Seriale",
      hobby_travel_desc: "Amante dell'esplorazione di nuove città, culture e scenari visivi che rigenerano continuamente il mio modo di creare.",
